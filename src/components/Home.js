          ...
          <Col lg={6} className="text-center text-lg-start">
            <div style={{ position: "relative", zIndex: 2 }}>
              ...
              <p style={{
                ...
                I'm a passionate Computer Science student specializing in full-stack development, 
                artificial intelligence, and innovative problem-solving. Currently advancing my 
                expertise in cutting-edge technologies to build the future of digital solutions.
              </p>
          ...
          <Col lg={6} className="text-center mt-5 mt-lg-0">
            <div style={{
              ...
              onMouseOver={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 15px 40px rgba(100, 255, 218, 0.3)";
              }}
              onMouseOut={(e) => {
